...
class DetailMuaPage extends StatelessWidget {
  final Map<String, dynamic> mua;
  
  const DetailMuaPage({super.key, required this.mua});
            ...
            Stack(
              children: [
                Container(
                  ...
                  child: mua['photo_url'] != null && mua['photo_url'].isNotEmpty
                      ? Image.network(
                          mua['photo_url'],
                          fit: BoxFit.cover,
                          width: double.infinity,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 10,
                    runSpacing: 10,
                    children: (mua['services'] as List? ?? 
                      ['Makeup Wisuda', 'Hair Do', 'Yearbook', 'Prewedding', 'Softlens'])
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => BookingPage(
                                    serviceName: mua['name'] ?? 'Glow Beauty',
                                    serviceType: 'mua',
                                    price: _parsePrice(mua['price'] ?? '350K'),
                                  ),
                                ),
                              );
                            },
